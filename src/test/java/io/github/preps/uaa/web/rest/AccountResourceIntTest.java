package io.github.preps.uaa.web.rest;

import io.github.preps.uaa.PrepaymentsuaaApp;
import io.github.preps.uaa.config.Constants;
import io.github.preps.uaa.domain.Authority;
import io.github.preps.uaa.domain.User;
import io.github.preps.uaa.repository.AuthorityRepository;
import io.github.preps.uaa.repository.UserRepository;
import io.github.preps.uaa.security.AuthoritiesConstants;
import io.github.preps.uaa.service.MailService;
import io.github.preps.uaa.service.UserService;
import io.github.preps.uaa.service.dto.PasswordChangeDTO;
import io.github.preps.uaa.service.dto.UserDTO;
import io.github.preps.uaa.web.rest.errors.ExceptionTranslator;
import io.github.preps.uaa.web.rest.vm.KeyAndPasswordVM;
import io.github.preps.uaa.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = PrepaymentsuaaApp.class)
public class AccountResourceIntTest {
    ...
    public void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restMvc.perform(
            post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO("1" + currentPassword, "new password"))))
    ...
    public void testChangePassword() throws Exception {
        ...
        restMvc.perform(
            post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "new password"))))
               .andExpect(status().isOk());
    ...
    public void testChangePasswordTooSmall() throws Exception {
        ...
        restMvc.perform(
            post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, newPassword))))
               .andExpect(status().isBadRequest());
    ...
    public void testChangePasswordEmpty() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, ""))))
               .andExpect(status().isBadRequest());
