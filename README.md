...
To optimize the prepaymentsuaa application for production, run:
...
The run : 
    ...
    docker build -t prepayments/prepayments-uaa:0.0.1-SNAPSHOT target/jib-docker-context
    
You can the push to docker registry with

     docker push prepayments/prepayments-uaa:0.0.1-SNAPSHOT
     
Or run it locally with:

     docker run -p 8486:8486 -td prepayments/prepayments-uaa:0.0.1-SNAPSHOT
